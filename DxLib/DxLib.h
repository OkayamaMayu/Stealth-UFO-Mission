...
//extern	int			SetIEProxySetting( void ) ;																							// ＩＥのプロキシ設定を適用する
...
extern	int			SetBlendGraphPositionMode(			int BlendGraphPositionMode /* DX_BLENDGRAPH_POSMODE_DRAWGRAPH など */ ) ;	// ブレンド画像の適用座標モードを設定する
